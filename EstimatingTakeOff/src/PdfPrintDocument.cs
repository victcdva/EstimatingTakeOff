...
namespace EstimatingTakeOff.src
{
    ...
    internal class PdfPrintDocument : PrintDocument
    {
        ...
        protected override void OnQueryPageSettings(QueryPageSettingsEventArgs e)
        {
            ...
            // Whether to adapt to the printing direction
            if (_settings.AutoOrientation)
            {
        ...
        private void PrintSinglePage(PrintPageEventArgs e)
        {
            ...
            {
                var pageOrientation = Orientation.Portrait;
                var printOrientation = Orientation.Portrait;

                // Whether to adapt to the printing direction
                if (_settings.AutoOrientation)
                {
                    pageOrientation = GetOrientation(_document.PageSizes[_currentPage]);
                    printOrientation = GetOrientation(e.PageBounds.Size);
        ...
        /// 绘制当前页
        /// </summary>
        /// <param name="e">为 PrintPage data provided by events</param>
        /// <param name="page">current page number</param>
        /// <param name="left">the x-coordinate of the upper-left corner of the drawn image</param>
        /// <param name="top">the y-coordinate of the upper-left corner of the drawn image</param>
        /// <param name="width">The width of the rectangular area of ​​the entire area of ​​the page</param>
        /// <param name="height">The height of the rectangular area of ​​the entire area of ​​the page</param>
