...
namespace EstimatingTakeOff.src
{
    public struct PdfRectangle : IEquatable<PdfRectangle>
    {
        ...
        public int Page { get { return _page - 1; } }
        public RectangleF Bounds { get; }
        public bool IsValid { get { return _page != 0; } }
        ...
        {
            return Page == other.Page && Bounds == other.Bounds;
        }

        public override bool Equals(object obj)
        {
            return obj is PdfRectangle rectangle && Equals(rectangle);
        }
